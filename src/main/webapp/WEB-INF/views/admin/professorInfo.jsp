	...
	$(document).ready(function() {
		  ...
		  function updateTable(data) {
		    ...
		    data.forEach(function(professor) {
		      html += '<tr>';
		      html += '<td>' + professor.pro_id + '</td>';
		      html += '<td>' + professor.pro_name + '</td>';
		      html += '<td>' + professor.pro_roomNum + '</td>';
		      html += '<td>' + professor.pro_roomNum + '</td>';
		      html += '<td>' + professor.pro_email + '</td>';
		      html += '<td>' + professor.dep_name + '</td>';
		      html += '<td></td>';
		      html += '</tr>';
		    });
		    $('#list').html(html);
